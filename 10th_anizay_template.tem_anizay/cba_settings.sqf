...
force ace_advanced_fatigue_performanceFactor = 1.0;
...
// ACE Cook off
force ace_cookoff_ammoCookoffDuration = 0.8;
...
force ace_cargo_loadTimeCoefficient = 4;
...
force ace_medical_menu_maxRange = 4;
...
force grad_trenches_functions_allowGigantEnvelope = true;
...
force grad_trenches_functions_gigantEnvelopeDigTime = 90;
...
force TFAR_setting_defaultFrequencies_lr_east = "31,32,33,34,35,36,37,38,39";
force TFAR_setting_defaultFrequencies_lr_independent = "31,32,33,34,35,36,37,38,39";
force TFAR_setting_defaultFrequencies_lr_west = "31,32,33,34,35,36,37,38,39";
force TFAR_setting_defaultFrequencies_sr_east = "111,112,113,114,115,116,117,118";
force TFAR_setting_defaultFrequencies_sr_independent = "111,112,113,114,115,116,117,118";
force TFAR_setting_defaultFrequencies_sr_west = "111,112,113,114,115,116,117,118";
...
force TFAR_Teamspeak_Channel_Password = "Mutti110";
