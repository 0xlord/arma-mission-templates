...
_player setVariable ["KAT_loadout", "USAM_SNI", true];
...
private _weapon = "rhs_weap_sr25";
private _items =  ["rhsusf_acc_SR25S", "rhsusf_acc_anpeq15side_bk", "rhsusf_acc_harris_bipod", "optic_LRPS"];
private _magazines = [];
