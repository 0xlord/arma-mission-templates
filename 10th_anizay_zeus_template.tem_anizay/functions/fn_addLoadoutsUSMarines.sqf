...
_object addAction ["<t color='#00BFFF'>Assistant Automatic Rifleman - M249</t>",{[player,"usm_rfl_aar_556"] call usmarines_fnc_LoadoutUSMarines;},nil,1.5,true,true,"","true",5,false,""];
_object addAction ["<t color='#00BFFF'>Assistant Automatic Rifleman - M240B</t>",{[player,"usm_rfl_aar_762"] call usmarines_fnc_LoadoutUSMarines;},nil,1.5,true,true,"","true",5,false,""];
