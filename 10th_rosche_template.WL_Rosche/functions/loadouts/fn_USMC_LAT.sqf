...
_player setVariable ["KAT_loadout", "USMC_LAT", true];
...
_player addItemToBackpack "rhs_mag_maaws_HEAT";
_player addWeapon "rhs_weap_maaws";
_player addSecondaryWeaponItem "rhs_optic_maaws";
