...
_object addAction ["<t color='#00BFFF'>MG-Schütze 2 - MG3</t>",{[player,"dea_aar_mg4"] call dearmy_fnc_LoadoutDEArmy;},nil,1.5,true,true,"","true",5,false,""];
...
_object addAction ["<t color='#00BFFF'>Zielfernrohrschütze</t>",{[player,"dea_rfl_dmr"] call dearmy_fnc_LoadoutDEArmy;},nil,1.5,true,true,"","true",5,false,""];
