...
if (isNil "KAT_gui_player_loadouts_BUND") exitWith {};
...
} forEach KAT_gui_player_loadouts_BUND;
...
} forEach KAT_gui_attachments_scope_BUND;
...
} forEach KAT_gui_attachments_goggles_BUND;
...
[_object, 0, ["KAT_loadoutActionParent", "KAT_loadoutAction_L"],
	["KAT_loadoutAction_L1", "PzF3 hinzufügen", "", {[player, "BWA3_PzF3"] call KAT_fnc_launcher;}, {true}] call ace_interact_menu_fnc_createAction
] call ace_interact_menu_fnc_addActionToObject;

[_object, 0, ["KAT_loadoutActionParent", "KAT_loadoutAction_L"],
	["KAT_loadoutAction_L1", "Bunkerfaust hinzufügen", "", {[player, "BWA3_Bunkerfaust"] call KAT_fnc_launcher;}, {true}] call ace_interact_menu_fnc_createAction
] call ace_interact_menu_fnc_addActionToObject;
