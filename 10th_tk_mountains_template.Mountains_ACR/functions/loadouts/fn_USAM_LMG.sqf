...
_player setVariable ["KAT_loadout", "USAM_LMG", true];

_player setUnitRank "PRIVATE";

/** CLOTHING */
_player forceAddUniform "VSM_Multicam_Crye_Tee_Camo";
...
_player addWeapon "hlc_m249_pip3";
